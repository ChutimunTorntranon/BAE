	...
	return (
		<div className='Box1 xl:mt-[20px] mt-[-1px]'>
			<div className='container mx-auto '>
				<div className='p-2 Font1 font-bold xl:text-[25px] xl:text-left text-[20px] text-center xl:ml-8'>
					<strong>{t('zinc1')}</strong>
				</div>
				<ul className='list-disc p-2 xl:ml-5'>
					<li className='p-1 Font2 xl:text-[21px] xl:text-left text-[15px] text-left  xl:ml-8'>
