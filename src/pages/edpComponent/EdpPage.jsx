  ...
  return (
    <div className="">
      <div className="xl:w-full xl:h-[200px] w-full h-[120px] bg-indigo-600">
        ...
        <div className="mx-auto container 2xl:flex text-center justify-between">
          <div>
            <Link to="/Zinc">
              <button className="Font1 text-[19px] hover:text-blue-600 duration-500 underline xl:ml-8">
                {t("e2")}
              </button>
            </Link>
          </div>
          ...
          <Link to="/Chromium">
            <button className="Font1 text-[19px] hover:text-blue-600 duration-500 underline xl:-ml-40">
              {t("e3")}
            </button>
          </Link>
        </div>
