...
function Slider() {
  const slides = [
    ...
    {
      url: "https://baeimagevideo.s3.ap-southeast-1.amazonaws.com/newImg/IMG_1573.jpg",
    },
  ];
  ...
  return (
    <div className="container xl:max-w-full 2xl:h-[570px] 2xl:w-auto w-[350px] h-[300px] 2xl:py-16 relative group">
      <div
