  ...
  return (
    <div className="mx-auto p-5">
      <div className="grid xl:grid-cols-4 grid-cols-1">
        <div>
          <iframe
            className="rounded-3xl my-10 mx-auto xl:w-[350px] xl:"
            width="350"
            height="255"
          ...
          <div>
            ...
            <div className="p-3 Font2 xl:text-[20px] xl:text-left text-[15px] text-center">
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{t("stamping")}
            </div>
          </div>
        </div>
        <div>
          <iframe
            className="rounded-3xl my-10 mx-auto xl:w-[350px]"
            width="350"
            height="255"
