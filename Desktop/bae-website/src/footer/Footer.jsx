	...
	return (
		<div className='bg-gray-200'>
			<div className='my-auto grid mx-auto container gap-3 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
				...
				<div className='mx-auto container'>
					<h1 className='p-3'>Contact Us (ติดต่อเรา)</h1>
					<div className='p-3 flex'>
						<BsFillTelephoneFill className='w-[50px] mt-1' /> : 083-101-8704 คุณ
						ณัฐดนัย (ฟิวส์)
					</div>
					<div className='p-3 flex'>
						<FiMail className='w-[50px] mt-1' /> : sale.software@baethai.com
					</div>
					<div className='p-3 flex'>
						<FaLine className='w-[50px] mt-1' /> : sale.bitsoft
					</div>
				</div>
			</div>
		</div>
